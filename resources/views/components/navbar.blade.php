<header class="bg-white border-b border-slate-300 sticky top-0 z-40">

    <div class="h-20 px-6 flex items-center justify-between">

        <div class="flex items-center gap-4">

            <button id="sidebarToggle" class="p-3 rounded-2xl bg-slate-100 text-slate-600 hover:bg-slate-200 transition">
